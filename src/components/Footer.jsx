      ...
      <footer className="bg-gray-900 text-gray-300 py-12">
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <h4 className="text-xl font-bold text-white mb-4">SmarTanom</h4>
              <p className="mb-4">The smart hydroponic system for modern farming solutions.</p>
              <div className="flex space-x-4">
                <a href="https://example.com" className="text-gray-400 hover:text-white transition">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#/Documentation" className="hover:text-emerald-400 transition">Documentation</a></li>
                ...
                <li><a href="#/Community" className="hover:text-emerald-400 transition">Community</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <form className="flex">
                <input 
                  ...
                  className="px-4 py-2 w-full rounded-l-lg focus:outline-none focus:ring-2 focus:ring-emerald-500 bg-gray-700 text-white"
                />
                <button 
                  type="submit"
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center">
            <p>&copy; {new Date().getFullYear()} SmarTanom. All rights reserved.</p>
          </div>
        </div>
      </footer>
    )
